...
def get_dimensions(nc_resource, var_names=None):
    ...
    if var_names:
        ...
        return list(ncdataset.dimensions.keys())
...
def create_dummy_netcdf(nc_file, nc_format='NETCDF4_CLASSIC', use_time=True,
                        ...
                        data_scale_factor=1.0, data_add_offset=0.0,
                        fill_mode=None, time_values=None, lon_values=None,
                        lat_values=None, var_values=None, verbose=False):
    """
    ...
    if verbose:
        str1 = "{0} values, {1} masked, for {2} Mb of uncompressed data."
        print_msg = str1.format(str(num_values), str(masked_values),
                                str(data_size_mb))
        print(print_msg)
